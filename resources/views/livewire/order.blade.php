            ...
            <div class="row">
                @foreach ($products as $product)
                    <div class="col-md-2 col-6">
                        <button class="btn btn-light" wire:click.prevent="tambahmenu({{ $product->id }})" data-toggle="modal" data-target="#exampleModal">
                            <img src="{{ asset('storage/' . $product->image)}}" style="object-fit:contain;
                            width:170px;
                            height:170px;
                            background-color: #d8ccba;" alt="">
                            <h5 class="text-dark">{{ $product->name }} (Rp. {{ number_format($product->price) }})</h5>
                        </button>
                    </div>
                @endforeach
            </div>
                    ...
                    <form>
                        ...
                        <div class="form-group">
                            <center>
                                ...
                                width:170px;
                                height:170px;
                                background-color: #F2EBDA;" src="{{ asset('storage/' . $productimage)}}" alt="daw">
                            </center>
                        </div>
                        <div class="form-group">
